        ...
        <div class="mainMemberRegister">
            <table>
                <tr>
                    <th>名稱: </th>
                    <td>
                        <asp:TextBox ID="txtMember_name" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th>性別: </th>
                ...
                <tr>
                    <th>狀態: </th>
                    <td>
                        <asp:Label ID="lblMember_Status" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <th>帳號: </th>
                    <td>
                        <asp:TextBox ID="txtMember_Account" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th>密碼: </th>
                ...
                <tr>
                    <th>E-MAIL: </th>
                    <td>
                        <asp:TextBox ID="txtMember_Mail" runat="server" TextMode="Email"></asp:TextBox>
                    </td>
                </tr>
            </table>
